...
def nn_feature_extract_vqa(df, logfile):
    ...
    for i in range(len(df)):
        ...
        image_path = "../../VQA_data/image/{}".format(image_name)
...
if __name__ == '__main__':
    ...
    vizwiz_val = pd.read_csv(os.path.join(args.src, 'vizwiz_skill_typ_val.hdf5'), skipinitialspace=True, engine='python')
    vizwiz_test = pd.read_csv(os.path.join(args.src, 'vizwiz_skill_typ_test.hdf5'), skipinitialspace=True, engine='python')
