...
vqa_text_recog_test = os.path.join(IMG_X, 'vqa_test_text_recognition.csv')

# question-based features
QSN_X = os.path.join(DATA_DIR, 'azure_feature_questions')

vizwiz_kp_train = os.path.join(QSN_X, 'vizwiz_train_keyphrases.csv')
vizwiz_kp_val = os.path.join(QSN_X, 'vizwiz_val_keyphrases.csv')
vizwiz_kp_test = os.path.join(QSN_X, 'vizwiz_test_keyphrases.csv')

vqa_kp_train = os.path.join(QSN_X, 'vqa_train_keyphrases.csv')
vqa_kp_val = os.path.join(QSN_X, 'vqa_val_keyphrases.csv')
vqa_kp_test = os.path.join(QSN_X, 'vqa_test_keyphrases.csv')
