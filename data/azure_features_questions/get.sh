...
url="https://drive.google.com/file/d/120XxGT_jCNFZuX8DSXTZNs0RD5FBzsGN/view?usp=sharing"
filename="azure_features_text.zip"
...
echo Saved: "$filename"
unzip azure_features_text.zip
rm azure_features_text.zip
echo "Done"
