...
url="https://drive.google.com/file/d/1x11grK82jWGzAn2zCQ2ukKH6RguQ0sgL/view?usp=sharing"
filename="azure_features_images.zip"
...
unzip azure_features_images.zip
rm azure_features_images.zip
echo "Done"
