...
vqa_train = pd.read_csv('../../data/three_vote_threshold/qa_skill_typ_train.csv', skipinitialspace=True, engine='python')
...
# validation sets
vqa_val = pd.read_csv('../../data/three_vote_threshold/qa_skill_typ_val.csv', skipinitialspace=True, engine='python')
vizwiz_val = pd.read_csv("../../data/three_vote_threshold/izwiz_skill_typ_val.csv", skipinitialspace=True, engine='python')
...
# test sets 
vqa_test = pd.read_csv('../../data/three_vote_threshold/qa_skill_typ_test.csv', skipinitialspace=True, engine='python')
